...
<%-- XSS: subject pre-populated from request parameter without escaping, to allow bookmarking --%>
<c:if test="${not empty param.prefill}">
  <div class="notice">Pre-filled from: ${param.prefill}</div>
</c:if>
